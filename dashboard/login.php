                        ...
                        <form  action="#" name="sentMessage" id="contactForm" novalidate>
                            ...
                            <div class="row control-group">
                                <div class="form-group col-xs-12 floating-label-form-group controls">
                                    ...
                                    <input name="pass" type="text" class="form-control" placeholder="Password" id="password" required data-validation-required-message="Please enter your password.">
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-xs-12">
                                    ...
                                    <button type="submit" class="btn btn-default"> <span href="dashboard/signup.php">Sign Up</span></button>
                                </div>
                            </div>
